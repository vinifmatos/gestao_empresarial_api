...
RSpec.describe 'Clientes', type: :request do
  ...
  describe 'GET /clientes' do
    it 'retorna código 200 e um array com os lançamentos' do
      get clientes_path, params: { page: 1, per_page: 25 }
      expect(response).to have_http_status(200)
      expect(response.body).to include_json(Cliente.all.page(1).per(25).as_json)
    end
  ...
  describe 'PUT /clientes/:id' do
    it 'retorna código 200 e um json com cliente atualizado' do
